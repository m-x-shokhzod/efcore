...
public class InternalEntityTypeBuilder : InternalTypeBaseBuilder, IConventionEntityTypeBuilder
{
    ...
    public virtual InternalIndexBuilder? HasIndex(
        IReadOnlyList<IReadOnlyList<MemberInfo>> memberChains,
        ConfigurationSource configurationSource)
        => HasIndex(ToPropertyBaseList(GetOrCreateProperties(memberChains, configurationSource)), configurationSource);
    ...
    public virtual InternalIndexBuilder? HasIndex(
        ...
        string name,
        ConfigurationSource configurationSource)
        => HasIndex(ToPropertyBaseList(GetOrCreateProperties(memberChains, configurationSource)), name, configurationSource);
